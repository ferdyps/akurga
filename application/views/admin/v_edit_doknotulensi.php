<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800">Edit Dokumentasi Rapat</h1>
  </div>
  <div class="container">
      ...
      <div class="row px-3 my-3">
          ...
          <div class="col">
            <div class="form-group form-input">
                ...
                <div class="invalid-feedback"></div>
                <a href="<?= base_url("sekretaris/dokumentasi_rapat").'/'.$row['no_notulen'];?>" target="_blank" class="d-none d-sm-inline-block btn btn-info shadow-sm" title="Detail Dokumentasi Rapat">Lihat Gambar</a>
          ...
          <div class="col">
            <div class="form-group form-input">
              ...
              <input type="text" name="ket_dok_rpt" id="edit-ket_dok_rpt" class="form-control" placeholder="(detail keterangan gambar)">
              <div class="invalid-feedback"></div>
