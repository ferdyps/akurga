    ...
    <div class="container-fluid">
      <div class="card w-50 mx-auto">
        <div class="card-header">
          <h1 class="text-center">Detail Dokumentasi Presensi</h1>
        </div>
        <?php foreach ($fetch as $row) { ?>
          <img width="500px" height="300px" class="img-thumbnail img-fluid mx-auto d-block card-img-top" src="<?= base_url('./assets/foto/notulensi/presensi/'. $row['dokumentasi_presensi'])?>">
        <div class="card-body">
